	   ...
	   <table width="75%" border="0"><tr><td width="180">
	   	...
	   	<br />
	   	<input name="restart" type="button" value="Restart Game" onClick="RestartConfirmation(<?php echo $numberinplay;?>)">
	   	
	   	
	   	</td><td rowspan=2 width="70%" valign=top>
	   	<b>Number of cards in play:</b> <input name="numberinplay" type="text" size="4" value="<?php echo $numberinplay; ?>">&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:explain('Cards in play')">help?</a>
	   	<br /><br /><font size="-1">(This set has a maximum of <?php echo $numbercards; ?> cards)</font><br />
